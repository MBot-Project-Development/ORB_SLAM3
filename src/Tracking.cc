...
void Tracking::PrintTimeStats()
{
    ...
    if(!vdRectStereo_ms.empty())
    {
        ...
        std::cout << "Stereo Rectification: " << average << " +- " << deviation << std::endl;
        f << "Stereo Rectification: " << average << " +- " << deviation << std::endl;
    }
    ...
    if(!vdResizeImage_ms.empty())
    {
        ...
        std::cout << "Image Resize: " << average << " +- " << deviation << std::endl;
        f << "Image Resize: " << average << " +- " << deviation << std::endl;
    }

    average = calcAverage(vdORBExtract_ms);
    deviation = calcDeviation(vdORBExtract_ms, average);
    std::cout << "ORB Extraction: " << average << " +- " << deviation << std::endl;
    ...
    if(!vdStereoMatch_ms.empty())
    {
        ...
        std::cout << "Stereo Matching: " << average << " +- " << deviation << std::endl;
    ...
    if(!vdIMUInteg_ms.empty())
    {
        ...
        std::cout << "IMU Preintegration: " << average << " +- " << deviation << std::endl;
        f << "IMU Preintegration: " << average << " +- " << deviation << std::endl;
    }

    average = calcAverage(vdPosePred_ms);
    deviation = calcDeviation(vdPosePred_ms, average);
    std::cout << "Pose Prediction: " << average << " +- " << deviation << std::endl;
    ...
    std::cout << "New KF decision: " << average << " +- " << deviation << std::endl;
    f << "New KF decision: " << average << " +- " << deviation << std::endl;

    average = calcAverage(vdTrackTotal_ms);
    deviation = calcDeviation(vdTrackTotal_ms, average);
    std::cout << "Total Tracking: " << average << " +- " << deviation << std::endl;
    ...
    std::cout << "Total Local Mapping: " << average << " +- " << deviation << std::endl;
    ...
    std::cout << "LBA KF optimized: " << average << " +- " << deviation << std::endl;
    ...
    std::cout << "LBA MP: " << average << " +- " << deviation << std::endl << std::endl;
    ...
    std::cout << "Database Query: " << average << " +- " << deviation << std::endl;
    ...
    std::cout << "SE3 estimation: " << average << " +- " << deviation << std::endl;
    average = calcAverage(mpLoopClosing->vdPRTotal_ms);
    deviation = calcDeviation(mpLoopClosing->vdPRTotal_ms, average);
    f << "Total Place Recognition: " << average << " +- " << deviation << std::endl << std::endl;
    std::cout << "Total Place Recognition: " << average << " +- " << deviation << std::endl << std::endl;
    ...
    std::cout << "Essential Graph: " << average << " +- " << deviation << std::endl;
    average = calcAverage(mpLoopClosing->vdLoopTotal_ms);
    deviation = calcDeviation(mpLoopClosing->vdLoopTotal_ms, average);
    f << "Total Loop Closing: " << average << " +- " << deviation << std::endl << std::endl;
    std::cout << "Total Loop Closing: " << average << " +- " << deviation << std::endl << std::endl;
    ...
    std::cout << "Number of KFs: " << average << " +- " << deviation << std::endl;
    ...
    std::cout << "Optimization Ess.: " << average << " +- " << deviation << std::endl;
    average = calcAverage(mpLoopClosing->vdMergeTotal_ms);
    deviation = calcDeviation(mpLoopClosing->vdMergeTotal_ms, average);
    f << "Total Map Merging: " << average << " +- " << deviation << std::endl << std::endl;
    std::cout << "Total Map Merging: " << average << " +- " << deviation << std::endl << std::endl;
    ...
    std::cout << "Number of MPs: " << average << " +- " << deviation << std::endl;
    ...
    f << "Total Full GBA: " << average << " +- " << deviation << std::endl << std::endl;
    std::cout << "Total Full GBA: " << average << " +- " << deviation << std::endl << std::endl;
